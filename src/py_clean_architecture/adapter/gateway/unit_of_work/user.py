...
from py_clean_architecture.application.service.user import UserServiceImpl
...
class UserUoWImpl(UserUoW):
    ...
    def __enter__(self: "UserUoWImpl") -> "UserUoW":
        ...
        self.user_service = UserServiceImpl(user_repo=user_repo, account_repo=account_repo)
        return self
